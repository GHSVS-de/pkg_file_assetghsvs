...
class pkg_assetghsvsInstallerScript extends InstallerScript
{
	/**
	...
	protected $removeFoldersOnUninstall = [
		'/media/assetghsvs'
	];
	...
	{
		$this->deleteFoldersOnUninstall();
	}

	protected function deleteFoldersOnUninstall()
	{
		if ($this->removeFoldersOnUninstall)
		{
